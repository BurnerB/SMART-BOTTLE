        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="{{ route('extras.update',$extra->id) }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('PATCH') }}
                        <div class="box-body">
                            ...
                            <div class="col-md-offset-3 col-md-6">
                                <div class="form-group text-center">
                                    <img src="{{ Storage::url($extra->image) }}"  alt="User Image" id="preview" height="100px" width="100px" onchange="previewImage(this)">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Name" required="required" value="{{ $extra->name }}">
                                </div>
                                    ...
                                    <select class="form-control select2" multiple="multiple" data-placeholder="Select categories"
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{ $category->id }}"
                                                    @foreach($extra->categories as $extracategory)
                                                    @if($extracategory->id == $category->id)
                                                    selected
                                                @endif
                                                @endforeach
                                            >
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="price" name="price" placeholder="eg price in ksh" required="required" value="{{ $extra->price }}">
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="slug">extras status</label><br>
                                    <div class="checkbox">
                        ...
                        <div class="box-footer">
                            ...
                            <a class="btn btn-warning" href="{{ route('extras.index') }}">Back</a>
                        </div>
                    </form>
                </div>
                <!-- /.box -->
